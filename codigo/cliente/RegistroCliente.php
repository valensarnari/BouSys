...
<body>
    <form action="#" method="post">
        ...
        <input type="text" name="documento" placeholder="Documento" class="input">

        <select name="nacionalidad" class="input">
        ...
        <input id="phone" type="tel" name="telefono" />
  ...
  <script>
        $(document).ready(function(){
            $('#loginClientes').on('submit', function(event) {
                ...
                $.ajax({
            type: 'POST',
            url: 'loginCliente.php', // Ruta al archivo PHP que procesará los datos
            data: formData,
            success: function(response) {  // Función que ejecuta si la solicitud es exitosa
                $('#respuesta').text(response).css('display', 'block');  // Muestra la respuesta en el elemento con id 'respuesta'
            },
